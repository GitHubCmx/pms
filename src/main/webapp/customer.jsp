...
<tr align="center" bgcolor="#FAFAF1" height="22">
  ...
  <c:forEach items="${customerList}" var="customer" varStatus="i">
      <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
          ...
          <td><a href="${pageContext.request.contextPath}/cust/edit/${customer.id}">编辑</a> | <a href="${pageContext.request.contextPath}/cust/read/${customer.id}">查看详情</a></td>
      </tr>
  </c:forEach>
...
<script type="text/javascript">
    ...
    function batchDelete() {
      ...
      $.ajax({
           type: "post",
           url: "${pageContext.request.contextPath}/cust/delCustomer",
