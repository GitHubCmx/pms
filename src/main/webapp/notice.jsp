                ...
                if(msg.map.statusCode==200){
                    $(msg.map.list).each(function (index,item) {
                          var tr="<tr align='center' bgcolor='#FFFFFF' onMouseMove='javascript:this.bgColor='#FCFDEE';' onMouseOut='javascript:this.bgColor='#FFFFFF';' height='22' >"
                                ...
                                +"</tr>";
                          $("#table-tr").before(tr);
                      /*  $("#ww").find("tr[id='table-tr']").before(tr);*/
                    });
                }
...
<table<%-- id="ww"--%> width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="12" background="${pageContext.request.contextPath}/skin/images/frame/topbg.gif">&nbsp;发件箱&nbsp;</td>
</tr>
